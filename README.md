...
Este repositorio contiene la aplicación cliente (SPA) para la plataforma Tech Blog, desarrollada con **Angular 20** y **TypeScript**. Incorpora un diseño premium responsivo con soporte para temas Claro/Oscuro y comunicación bidireccional en tiempo real.
...
*(Nota: Se utiliza la bandera `--legacy-peer-deps` para evitar que el instalador de npm falle debido a advertencias estrictas de dependencias cruzadas entre Angular 20 y `zone.js` en entornos locales).*
