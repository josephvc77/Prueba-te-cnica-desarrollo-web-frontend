...
* **A03:2025 - Software Supply Chain Failures (Fallas en la Cadena de Suministro de Software)**:
  * *Mitigación*: Uso exclusivo de paquetes de confianza firmados en NPM. Escaneo estático ejecutado mediante `npm audit` and Snyk, arrojando 0 vulnerabilidades en todas las librerías del código en producción de backend y frontend.
